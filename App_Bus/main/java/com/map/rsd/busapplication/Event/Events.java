...
import com.map.rsd.busapplication.BuildConfig;
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        latitude = Double.parseDouble(intent.getStringExtra(LocationMonitoringService.EXTRA_LATITUDE));
                        longitude = Double.parseDouble(intent.getStringExtra(LocationMonitoringService.EXTRA_LONGITUDE));


                        Log.e("ffvvvv", "onReceive:"+latitude+""+longitude);
...
//         url = "https://moumenmadrid65.000webhostapp.com/station.php";
        url = getString(R.string.api_prefix)+"eventContex"+"/"+3+"/"+5;
